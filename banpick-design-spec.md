...
| D32 | Rematches             | A finished match can open (or find) its rematch room. Idempotent, so both players pressing it land in one room                                                           | Two players pressing "again" should not produce two rooms each waiting for the other. Seating was left as the ordinary lobby flow on §12.3 grounds; **D53 reverses that half** — a rematch is the one room whose terms both players have already played under |
...
### D44 — history that was not played here (2026-08-26)

| #   | Decision               | Choice                                                                                                                                                                                                                                                                                | Rationale                                                                                                                                                                                                                                                                                                                           |
| --- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D44 | Adding a match by hand | `/admin` **files a match this deployment never refereed**, behind `ADMIN_KEY` like D34's edit. Room code prefixed `M-`, no rosters, never a `tournamentId`, and the history labels the row _added by hand_. A seat with no player id gets one minted, reconciled later by D35's merge | The record was only ever as complete as the evenings somebody remembered to open the site for. Inventing a row is D34's power used a different way rather than a lesser one, so it gets the same key — and the same honesty: a row nobody's client reported is a weaker claim than one two seats agreed on, and the page says which |

### D45 — the record, counted by hero (2026-08-28)

| #   | Decision          | Choice                                                                                                                                                                                                                                                                                                                                   | Rationale                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| --- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D45 | Per-hero win rate | The stored match gains a **`lineup`** — which character each seat played in each round, indexed against `detail.rounds`. `/heroes` is the leaderboard's second board, ranking on the share of rounds won at any sample size, with each hero's **best and worst matchups** under it. Rounds recorded before D45 are counted as uncredited | A round is one hero against one hero, so a round is where a hero's record lives — and `played` could not deliver it, being the consumed slots in _slot_ order. §15 has asked for win rate by hero since day one. A minimum-rounds gate was tried and cut on the owner's call: the record sits on the row beside the rate. Matchups split on wins against losses, so a draw never has to be priced. The gap left by pre-D45 rounds is reported rather than hidden — and **narrowed by D47**, which found that much of it was deducible after all |

### D46 — heroes on a hand-written record (2026-08-28)

| #   | Decision           | Choice                                                                                                                                                                                                                 | Rationale                                                                                                                                                                                                                                                                                                 |
| --- | ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D46 | Admin picks heroes | The add and edit forms carry a **hero per seat per round**, validated against the roster (retired ids accepted). On an edit `played` follows the lineup and `drafted` only grows. D44's read-only rosters are reversed | D44 was right that a wrong roster is a different game — while nothing counted one. D45 made an unattributed round a missing row on a public table, and a match whose Durable Object expired has no other path to a correction. Validated because a typo'd id is a hero nobody would recognise as an error |

### D47 — what the old records could always tell us (2026-08-28)

| #   | Decision                 | Choice                                                                                                                                                                                                                                                                | Rationale                                                                                                                                                                                                                                                                                             |
| --- | ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D47 | Deducing a pre-D45 round | A round with no `lineup` is credited when **every played round of its match went the same way** — the order is unknowable, the result is not. A **single** played round settles the pairing as well. A split is left uncredited, never halved. Recorded beats deduced | D45 said those rounds "cannot be attributed", which was too strong: `consumed` is set at _selection_, so `played` holds one hero per round that happened. Sweeps and Bo1s are most of the archive. Halving a split would put a result no game produced on a public table, where nobody could check it |

### D48 — the games behind a hero (2026-08-28)

| #   | Decision         | Choice                                                                                                                                                                                                                                                                              | Rationale                                                                                                                                                                                                                                                                                                   |
| --- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D48 | Per-hero history | A hero's row on `/heroes` opens an inline panel: every opponent it has met, and every round it has played — who held it, against whom, the format, the round, the outcome. Served by `/api/hero?id=`, fetched on open. A round deduced by D47 reports `round: null` and no opponent | Forty-four heroes' worth of match lists is a download rather than a table, so it is its own route and lazy. Read through the same round-reader the board counts, so a total and the games it is a total of cannot disagree. Naming a round a sweep cannot place would be the one invented thing on the page |

### D49 — deleting and correcting a tournament (2026-08-28)

| #   | Decision         | Choice                                                                                                                                                                                                                                                                           | Rationale                                                                                                                                                                                                                                                                                                                                                                |
| --- | ---------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| D49 | Tournament admin | `/admin` **deletes a tournament** — closing its Durable Object, dropping the registry row and archived bracket, and **releasing** its matches rather than deleting them. The only edit is **renaming an entrant**, on a finished tournament, across summary and archived bracket | A tournament lives in three places and deleting one is deleting the row it refiles from. Its games were played and still count. Everything but a display name is derived from resolved slots, so an admin restating one would be D39's second truth; a running tournament would overwrite the rename on its next result, and the organizer console renames at the source |

### D50 — the fun ones (2026-08-28)

| #   | Decision    | Choice                                                                                                                                                                                                                                                                                | Rationale                                                                                                                                                                                                                                                                                                               |
| --- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D50 | Stats board | `/stats`, the leaderboard's third tab: most picked, hated, played, benched, mirrored and **stolen**, plus per player what they bring, who they ban and **what is banned against them**. The match count is printed above the superlatives. Counter-picks and ban hit rate are omitted | Counts over the same rows every other total reads, so an edit moves them. "Most hated" over eleven matches is a fact about one evening, so the sample is on the page. Selection order was never stored, and a meta ban's hit is invisible either way it lands — approximating either would be a statistic about nothing |

### D51 — closing the collection gaps (2026-08-28)

| #   | Decision              | Choice                                                                                                                                                                                                                                                                                   | Rationale                                                                                                                                                                                                                                                                                                                                                                                                          |
| --- | --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| D51 | What the record keeps | The stored match gains **which seat selected first** per round (`null` when blind), **the round ban** as the character it denied, and **the mode id**. They feed most counter-picked, most answered and most denied. §15's O6 hit rate is declared unmeasurable rather than approximated | Each blocked a figure somebody asked for, and each was a fact the match held and dropped — D45's problem three more times. A round ban happens three times a match to the meta ban's once, so "most hated" was answering a narrower question than it looked. O6 assumes a ban landing after the draft; every shipped mode bans before it, so the ban prevents rather than denies and no column makes it observable |

### D52 — one pick, no bans (2026-08-28)

| #   | Decision    | Choice                                                                                                                                                                                                                        | Rationale                                                                                                                                                                                                                                                                                                                                                            |
| --- | ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D52 | `bo1-pick1` | One character each, committed blind and revealed together; one round; **no ban, no roll, no selection step**. Written as configuration alone — no engine change. Forced selections are excluded from D51's counter-pick order | A ban against a single pick decides the match before either seat chooses, and a roll hands out a privilege this format does not have. The select stays because it is what consumes the slot and feeds D45's lineup; D26 auto-commits it. §1 promised modes are configuration, and this is the first mode unlike the others to test that without spending engine work |

### D53 — a rematch keeps its seats (2026-08-29)

| #   | Decision          | Choice                                                                                                                                                                                                                                                                                                                             | Rationale                                                                                                                                                                                                                                                                                                                                                                                                             |
| --- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| D53 | Seating a rematch | D32's room is now opened **with both seats already filled**, under the identities the finished match recorded and in the same letters. Each seat's token goes to that seat alone — in the opener's HTTP reply, and per-socket on the `REMATCH` frame — and both clients walk straight in. Unseatable seats still get the join page | §12.3 protects consent to **terms you have not seen**, and a rematch is the one room with none: the ruleset is copied verbatim from a match both players just finished. Reading the rule more broadly cost the feature — two people retyped their names into a lobby for a game they were already playing. The token is the one value on that wire that is not safe to fan out, so it is the only thing sent per seat |
