 ...
 *
 * This used to be the whole front page, sitting under the title with the join field beneath it —
 * every visitor met a form whether or not they had come to host anything. It is its own screen at
 * `/host` now, reached from the menu, which is what lets that page be a menu at all.
 */
  ...
  return (
    <main className="screen">
      <header className="hero">
        ...
        <p className="hero__sub">Pick the rules, then send the link</p>
